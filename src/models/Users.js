...
export default class Users extends Model {
  ...
  static associate(models) {
    this.hasMany(models.UserCCEmails, { foreignKey: 'user_id' })
  }

  static associate(models) {
    this.hasMany(models.UserCCOffers, { foreignKey: 'user_id' })
  }
  ...
  static associate(models) {
    this.hasMany(models.UserCCMilestones, { foreignKey: 'user_id' })
  }

  static associate(models) {
    this.hasMany(models.UserCCDeals, { foreignKey: 'user_id' })
  }
  
  static associate(models) {
    this.hasMany(models.UserCCStatements, { foreignKey: 'user_id' })
  }
